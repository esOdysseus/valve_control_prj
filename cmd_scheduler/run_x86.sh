...
function runner_set_env() {
    ...
    export LD_LIBRARY_PATH=${__PROG_ROOT_PATH__}/lib/communicator/lib/x86:${LD_LIBRARY_PATH}
}
...
function runner_start_program() {
    ...
    local ALIAS_FILE_PATH=${__PROG_ROOT_PATH__}/lib/communicator/config/desp_alias.json
