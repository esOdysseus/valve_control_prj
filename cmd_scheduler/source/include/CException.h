...
typedef enum E_ERROR {
    ...
    E_ERR_FAIL_CHECKING_CMD_VALIDATION,
    E_ERR_FAIL_CALCULATE_TIME,
    E_ERR_FAIL_GET_TIME,
    E_ERR_FAIL_PRINT_TIME,
    E_ERR_FAIL_OPEN_FILE,
    E_ERR_FAIL_READ_FILE,
    E_ERR_FAIL_WRITE_FILE,

    E_ERR_INVALID_CMD               = 29,
    E_ERR_INVALID_VALUE,
    E_ERR_INVALID_NULL_VALUE,
    E_ERR_INVALID_ARG_COUNT,
    E_ERR_INVALID_INDEX_NUM,

    E_ERR_NOT_SUPPORTED_CMD         = 34,
    E_ERR_NOT_SUPPORTED_WHAT,
    E_ERR_NOT_SUPPORTED_HOW,
    E_ERR_NOT_SUPPORTED_TYPE,
    E_ERR_NOT_EXISTED_PROC,

    E_ERR_NOT_HAVE_MEMBER           = 39,
    E_ERR_NOT_ARRAY,
    E_ERR_NOT_IMPLEMENTED,

    E_ERR_NEED_TIME_SYNC            = 42,
...
private:
    const char* exception_switch(E_ERROR __err_n) const throw() {
        ...
        case E_ERR_FAIL_CHECKING_CMD_VALIDATION:
            return "E_ERR_FAIL_CHECKING_CMD_VALIDATION occured.";
        case E_ERR_FAIL_CALCULATE_TIME:
            return "E_ERR_FAIL_CALCULATE_TIME occured.";
        case E_ERR_FAIL_GET_TIME:
            return "E_ERR_FAIL_GET_TIME occured.";
        case E_ERR_FAIL_PRINT_TIME:
            return "E_ERR_FAIL_PRINT_TIME occured.";
        case E_ERR_FAIL_OPEN_FILE:
            return "E_ERR_FAIL_OPEN_FILE occured.";
        case E_ERR_FAIL_READ_FILE:
            return "E_ERR_FAIL_READ_FILE occured.";
        case E_ERR_FAIL_WRITE_FILE:
            return "E_ERR_FAIL_WRITE_FILE occured.";
        ...
        case E_ERR_NOT_IMPLEMENTED:
            return "E_ERR_NOT_IMPLEMENTED occured.";
