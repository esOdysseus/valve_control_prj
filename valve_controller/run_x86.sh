...
function runner_set_env() {
    ...
    export LD_LIBRARY_PATH=${__COMMON_LIB_ROOT__}/lib/communicator/lib/x86:${LD_LIBRARY_PATH}
}
...
function runner_start_program() {
    ...
    local ALIAS_FILE_PATH=${__COMMON_LIB_ROOT__}/lib/communicator/config/desp_alias.json
    local PROTO_FILE_PATH=${__COMMON_LIB_ROOT__}/lib/communicator/config/desp_UniversalCMD_protocol.json
